                    ...
                    <div class="row py-5">
                        @forelse($product as $pro)
                            <div class="col-md-3">
                                ...
                                <img src="{{asset('images/product/'.$pro->product_image) }}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title font-weight-bold text-danger">{{ $pro->name }}</h5>
                                    <p class="card-text text-danger">{{ $pro->product_description }}</p>
                                    <a href="{{ url('product/'.str_replace (' ','_',$pro->id)) }}" style="background-color:#943D2B;" class="btn text-white">Go somewhere</a>
                                </div>
                                </div>
                            </div>
                        @empty
